...
images. The label for each image is taken from the name of the  it's in.
...
def main(_):
    ...
    with tf.Session(graph=graph) as sess:
        ...
        # constants.
        trained_graph_def = graph_util.convert_variables_to_constants(
                sess, graph.as_graph_def(), [FLAGS.final_tensor_name])
        with gfile.FastGFile(FLAGS.trained_graph, 'wb') as f:
            f.write(trained_graph_def.SerializeToString())
        with gfile.FastGFile(FLAGS.trained_labels, 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--trained_graph',
        type=str,
        default='/tmp/trained_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--trained_labels',
        type=str,
        default='/tmp/trained_labels.txt',
